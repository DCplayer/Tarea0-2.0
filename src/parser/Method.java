...
public class Method extends Elemento {
    ...
    public Method(String name, ArrayList<ArrayList<String>> signature, ArrayList<ArrayList<String>> returnValue, ArrayList<ArrayList<String>> typeValue ,Stack<SyTable> symbolTable) {
